        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="func-tab clearfix">
                    <div class="func-cont" onClick="void(0)">
                        <a href="javascript:void(0)" class="dropdown-toggle">
                            <img class="func-icon" src="${envData.staticRoot!''}/images/custom/icon-hg.png"/>报表模板
                        </a>
                    </div>
                    <div class="func-cont">
                        <a href="#" target="blank"
                           class="dropdown-toggle">
                            <img class="func-icon" src="${envData.staticRoot!''}/images/custom/icon-dd.png"/>报表数据
                        </a>
                    </div>
                </div>
                <!--关键指数-->
