        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="javascript:void(0);" data-link="/autoReport/reportParamsMgr"
                               data-menukey="reportParamsMgr"><i class="fa fa-link"></i> <span>报表参数</span> </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-link="/autoReport/reportDbConnMgr"
                               data-menukey="reportDbConnMgr"><i class="fa fa-link"></i> <span>数据连接</span> </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-link="/autoReport/reportManager"
                               data-menukey="reportManager"><i class="fa fa-link"></i> <span>报表管理</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-link="/autoReport/reportQueryMgr"
                               data-menukey="reportQueryMgr"><i class="fa fa-link"></i> <span>报表查询</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <div class="nav-tabs-custom"> <!-- nav-tabs-custom -->
                ...
                <div class="tab-content" id="menu_content">
                    <div class="tab-pane active" id="HOME0">
                        <iframe src="/autoReport/reportMain" frameborder=0 width="100%" height="850px" scrolling=no>
                        </iframe>
                    </div><!-- /.tab-pane -->
                </div><!-- /.tab-content -->
            </div><!-- /.nav-tabs-custom -->
...
<script type="text/javascript">
    ...
    function showOpenReport() {
        var nav = '<i class="fa fa-dashboard"></i>首页>>打开报表';
        var url = '/autoReport/openReport?reportCode=1001';
        jumpPage(url, "打开报表","OPEN_REPORT", nav);
    }
</script>